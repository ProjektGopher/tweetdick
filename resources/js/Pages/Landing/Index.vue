          ...
          <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span class="block text-indigo-200">Twitter DMs</span>
              </h1>
              <p class="mt-6 max-w-lg mx-auto text-center text-xl text-white sm:max-w-3xl">TweetDick is a middleware that sits between you and your DMs to help deal with unwanted dick pics.</p>
          ...
          <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
            <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
              <div>
                ...
                <div class="mt-6">
                  <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">Automatic attachment scanning</h2>
                  <p class="mt-4 text-lg text-gray-500">Every time you get sent an image in your DMs, we'll intercept it, and run it through our AI to look for unwanted content. If it passes, we'll transparently do nothing. It it fails, we'll give you tools to deal with it.</p>
                  <div class="mt-6">
